...
const TouchableAndroid = styled(TouchableNativeFeedback, { shouldForwardProp })(
  // { className: 'TouchableAndroid' },
  (
...
const AnimatedTouchableAndroid = animated(TouchableAndroid);

export { AnimatedTouchableAndroid, TouchableAndroid };
