...
const TouchableNoFeedback = styled(TouchableWithoutFeedback, { shouldForwardProp })(
  // { className: 'TouchableNoFeedback' },
  (
...
const AnimatedTouchableNoFeedback = animated(TouchableNoFeedback);

export { AnimatedTouchableNoFeedback, TouchableNoFeedback };
